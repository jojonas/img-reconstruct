...
def parse_args():
    ...
    parser.add_argument("--low", help="Lower percentile to adjust curves to (0-1).", type=float, default=0.01)
    parser.add_argument("--high", help="Upper percentile to adjust curves to (0-1).", type=float, default=0.95)
    parser.add_argument("--pad-low", help="Additional padding below the histogram (0-255).", type=float, default=5)
    parser.add_argument("--pad-high", help="Additional padding above the histogram (0-255).", type=float, default=20)
